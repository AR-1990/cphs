      ...
      { target: "Array", proto: !0, forced: !d || !h },
      {
        slice: function (t, e) {
          ...
          if (
            ...
            return y.call(l, d, h);
          for (
            r = new (void 0 === n ? Array : n)(g(h - d, 0)), f = 0;
            d < h;
            d++, f++
          )
            d in l && s(r, f, l[d]);
        ...
        (e = Array.prototype.slice.call(e)).forEach(function (t) {
          t.addEventListener("mdk-drawer-change", function (t) {
            if (t.target.mdkDrawer) {
              ...
              e &&
                e.classList[t.target.mdkDrawer.opened ? "add" : "remove"](
                  "active"
                );
            }
          });
  ...
  function (t, e, n) {
    n(46),
      ...
      (function () {
        ...
        function n() {
          this.mdkReveal && this.mdkReveal.close(),
        ...
        $(document).on(
          "".concat(o.CLICK_DATA_API, " ").concat(o.KEYUP_DATA_API),
          function (t) {
      ...
      return {
        ...
        _reset: function () {
          this.image &&
            ...
            (this.element.style.backgroundImage = "url(".concat(
              this.image.src,
              ")"
            )),
  ...
  function (t, e, n) {
    ...
    var r = function () {
      return {
        ...
        play: function () {
          this.element
            .querySelector(".player__embed")
            .classList.remove("d-none"),
            (this.element.querySelector(".player__embed iframe").src +=
              "&autoplay=1");
        },
        onClick: function (t) {
...
sidebarItems.forEach(sidebarItem => {
  // Get the href attribute of the sidebar menu item link
  const linkURL = sidebarItem.querySelector('a').getAttribute('href');

  // Check if the current page URL matches the sidebar menu item link URL
  if (window.location.href.includes(linkURL)) {
    // Add the "active" class to the sidebar menu item
