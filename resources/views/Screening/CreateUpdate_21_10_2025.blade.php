...
@section('content')
 ...
 <div class="form-group col-md-12">
                        ...
                        <div>
                            <input type="text" class="form-control" id="expouser_result" name="expouser_result" disabled>
                        </div>
                    </div>
                    <!-- Comment -->
                    <div class="form-group col-md-12">
...
$('.NutritionistOptionsAttribute').each(function() {
    ...
    $('#Question_No65_How_many_glasses_of_waterliquids_do_you_consume_in_a_day,#food_items').on('change', function() {
        updateComments();
        setDataValueForOptions1();
    });
