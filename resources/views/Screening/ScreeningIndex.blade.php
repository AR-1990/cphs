...
@section('content')
    ...
    <div class="container-fluid page__container page__container page-section" style="max-width: 100% !important;">
        ...
        <div class="upload_csv d-flex justify-content-end align-items-center mb-3">
            <div class="date_flex">
                <input type="date" id="startIndex" class="form-control"/>
                <input type="date" id="endIndex" class="form-control"/>
                <button type="button" class="btn btn-primary mr-2" id="dateSearchBtnIndex">Search</button>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    ...
                    url: "{{ route('ScreeningListIndex') }}",
                    data: function(d) {
                        d.schoolId = $('#schoolId').val(); // Pass additional parameters if needed
                        d.fromDate = $('#startIndex').val();
                        d.toDate = $('#endIndex').val();
            ...
            $('#dateSearchBtnIndex').on('click', function(){
                table.ajax.reload();
            });
