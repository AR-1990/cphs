...
@section('content')
    ...
    <div class="container page__container page__container page-section">
        ...
        <div class="page-separator">
            <div class="page-separator__text"> Physician</div>
        </div>
        <!-- Add date filter input fields -->
        <div class="row mb-3">
            <div class="col-md-3">
                <label for="fromDate"> Physician</label>
                ...
                <table class="table table-stripped table-bordered datatable" id="datatable" style="z-index:3;width:100%">
                    <thead style="color:black; width:100%!important">
                        <tr role="row" class="bg-primary white">
                            ...
                            <th>Physician Refer</th>
                            <th>{{ preg_replace('/(?<!^)([A-Z])/', ' $1', 'PhysicianFollowUp') }}</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var base_url = '{!! Route('PhysicianList') !!}';
