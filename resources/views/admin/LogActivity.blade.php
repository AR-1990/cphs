...
@section('content')
    ...
    <div class="container page__container page__container page-section">
        <div class="d_performance">
            ...
            <form action="javascript:void(0);" method="get" id="DatatableFilter">
                <div class="mb-3">
        ...
        <div class="page-separator">
            <div class="page-separator__text">Log Activity</div>
        </div>
        <!-- Add date filter input fields -->
        <div class="row mb-3">
            <div class="col-md-3">
                <label for="fromDate">Log Activity</label>
...
<script>
    $(document).ready(function() {
        ...
        var base_url = '{!! Route('LogActivityList') !!}';
