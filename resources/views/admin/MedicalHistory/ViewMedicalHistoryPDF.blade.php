                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input placeholder="GR Number"  type="number" step="any"  class="form-control" id="GRNo" name="GRNo"
        ...
        <div class="row">
            <div class="form-group col-md-12 my-3">
                <ul class="nav nav-tabs justify-content-center mx-auto" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if(!empty($SchoolHealthPhysician)) active @endif" id="home-tab" data-toggle="tab" href="#home" role="tab"
                            aria-controls="home" aria-selected="true">School Health Physician</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  @if(!empty($NutritionistHistoryEvaluationSection)) active @endif" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                            aria-controls="profile" aria-selected="false">Nutritionist</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(!empty($PsychologistHistoryAssessmentSection)) active @endif"  id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                ...
                <div class="tab-content mb-5" id="myTabContent">
                    ...
                    <div class="tab-pane fade  @if(!empty($SchoolHealthPhysician)) active  show @endif py-4" id="home" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Teeth" name="Teeth" id="Teeth" class="form-control"
                                            required
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Past Surgical History" name="Past_Surgical_History" required
                                            id="Past_Surgical_History" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Family History" name="Family_History1" id="Family_History1"
                                            required class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Blood pressure" name="Blood_pressure" id="Blood_pressure"
                                            class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Chest" name="Chest" id="Chest" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Heart" name="Heart" id="Heart" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Abdomen" name="Abdomen" id="Abdomen" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Problem List" name="Problem_List" id="Problem_List" required
                                            class="form-control"
                            ...
                            <div class="form-row d-none" id="follow_up_show">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" placeholder="Reason for Follow-up" name="Follow_up_Date"
                                        ...
                                        <select id="external_referrals" name="external_referrals[]"
                                            ...
                                            @else
                                                ...
                                                <option value="Clinical Psychology"
                                                    @if (in_array('Clinical Psychology', $external_referralsArr)) selected @endif>Clinical Psychology
                                                </option>
                                                <option value="Dentistry"
                                                    @if (in_array('Dentistry', $external_referralsArr)) selected @endif>
                                                    Dentistry</option>
                                                <option value="Dermatology"
                                                    @if (in_array('Dermatology', $external_referralsArr)) selected @endif>Dermatology</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade @if(!empty($NutritionistHistoryEvaluationSection)) active show @endif" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="BMI (auto-generated)" name="BMI" required id="BMI1"
                                            class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="Physical Activity Levels"
                                            placeholder="Physical Activity Level" name="Physical_Activity_Level" required
                                            id="Physical_Activity_Level" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="Estimated Energy Requirement"
                                            placeholder="Estimated Energy Requirement" name="Estimated_Energy_Requirement"
                                            required id="Estimated_Energy_Requirement" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="Daily Fat Requirement" placeholder="Daily_Fat_Requirement"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="Daily Fluid Requirement"
                                            placeholder="Daily Fluid Requirement" name="Daily_Fluid_Requirement" required
                                            id="Daily_Fluid_Requirement" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="Chief Complaints" placeholder="Chief Complaints"
                                            name="Chief_Complaints2" required id="Chief_Complaints2" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="Family History" placeholder="Family History" name="Family_History2"
                                            required id="Family_History2" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="Bed_time_snack" class="form-control" name="Bed_time_snack" required>
                                            <option value="">Select</option>
                                            <option value="Yes"
                                                @if (
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $provisionalArray = [];
                                            if (
                                                !empty($NutritionistHistoryEvaluationSection['Provisional_Diagnosis1'])
                                            ) {
                                                $provisionalArray = explode(
                                                    '|',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="internal_referrals1" name="internal_referrals1[]" required
                                            ...
                                            @php
                                                $selectedValues = [];
                                                if (
                                                    !empty($NutritionistHistoryEvaluationSection['internal_referrals1'])
                                                ) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="external_referrals1" name="external_referrals1[]" required
                                            ...
                                            @php
                                                $selectedValues = [];
                                                if (
                                                    !empty($NutritionistHistoryEvaluationSection['external_referrals1'])
                                                ) {
                                                    $selectedValues = explode(
                                                        '|',
                    ...
                    <div class="tab-pane fade @if(!empty($PsychologistHistoryAssessmentSection)) active show @endif" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <div class="form-row mt-5">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Personal & Social History" name="Personal_Social_History3"
                                            id="Personal_Social_History3" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Mood" name="Mood" id="Mood" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Thought Process & Content" name="Thought_process_content"
                                            id="Thought_process_content" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Impression" name="Impression2" id="Impression2" required
                                            class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="Provisional_Diagnosis2[]" id="Provisional_Diagnosis2" required
                                            ...
                                            @php
                                                ...
                                                if (
                                                    !empty(
                                                        $PsychologistHistoryAssessmentSection['Provisional_Diagnosis2']
                                                    )
                                                ) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="internal_referrals2[]" id="internal_referrals2"
                                            ...
                                            @php
                                                $selectedValues = [];
                                                if (
                                                    !empty($PsychologistHistoryAssessmentSection['internal_referrals2'])
                                                ) {
                                                    $selectedValues = explode(
                                                        '|',
