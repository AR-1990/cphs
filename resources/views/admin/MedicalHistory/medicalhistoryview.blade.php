...
@section('content')
    ...
    <div class="container">
        ...
        <form id="multiStepForm"
            @if (!empty($StudentBiodata)) action="{{ route('medicalhistorydata') }}"  @else action="{{ route('StudentBiodata') }}" @endif
            form method="POST">
            ...
            <div class="step active mb-5" id="step1">
                ...
                <div class="form-row">
                     @foreach ($StudentBiodata as $student)
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input  placeholder="GR Number" type="number"  class="form-control" id="GRNo" name="GRNo"
                            value="{{ $student->GRNo }}" readonly>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            value="{{ $student->B_Form_Number }}" readonly>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input placeholder="Gender" type="text" class="form-control" id="gender" name="gender"
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            <label for="School_Name">School Name</label>
                                ...
                                name="School_Name"
                                value="{{ $student->School_Name }}" readonly>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            <label for="Emergency_Contact_Number">Emergency Contact Number</label>
                                <input placeholder="Emergency Contact Number" type="text" class="form-control"
                                id="Emergency_Contact_Number" name="Emergency_Contact_Number"
                                value="{{ $student->Emergency_Contact_Number }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input  class="form-control" id="type_of_encounter" name="type_of_encounter" class="form-control"
                            id="Emergency_Contact_Number" name="Emergency_Contact_Number"
                            value="{{ $student->type_of_encounter }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-12 my-3">
                    ...
                    <div class="tab-content mb-5" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active py-4" id="home" role="tabpanel"
                            ...
                            <form id="multiStepForm" action="{{ route('SchoolHealthPhysician') }}" method="POST">
...
{{-- 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="external_referrals" name="external_referrals[]"
                                                ...
                                                <option value="Cardiology"
                                                    @if (in_array('Cardiology', $external_referralsArr)) selected @endif>Cardiology</option>
                                                ...
                                                <option value="Dentistry"
                                                    @if (in_array('Dentistry', $external_referralsArr)) selected @endif>Dentistry</option>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <form id="multiStepForm1" action="{{ route('NutritionistHistoryEvaluationSection') }}"
                                method="POST">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input readonly value="Daily Fat Requirement"
                                                placeholder="Daily_Fat_Requirement" name="Daily_Fat_Requirement" required
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="Family History" placeholder="Family History"
                                                name="Family_History2" required id="Family_History2" class="form-control"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Bedtime" name="diet_bedtime"
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <form id="multiStepForm" action="{{ route('PsychologistHistoryAssessmentSection') }}"
                                method="POST">
                                @csrf
...
{{-- <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script> --}}
    ...
    <script>
        ...
        @if (
            !empty($NutritionistHistoryEvaluationSection['Breakfast']) &&
                $NutritionistHistoryEvaluationSection['Breakfast'] == 'Yes')
        ...
        @if (!empty($NutritionistHistoryEvaluationSection['Lunch']) && $NutritionistHistoryEvaluationSection['Lunch'] == 'Yes')
