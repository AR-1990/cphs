...
<style>
        ...
        <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
            ...
            <div class="row" role="tablist">
                <div class="col-auto">
                    ...
                    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addStudentModal">  <i class="fas fa-user-plus"></i>View</button> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container page__container page__container page-section">
        <div class="page-separator">
            <div class="page-separator__text">Data Bank</div>
        </div>
        <div class="card mb-0 bg-light border-0">
            <div class="car_padding">
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="date_databank">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="date_databank">
                            <label for="select_schools">Schools: </label>
                            <select name="select_schools" id="select_schools" class="form-control">
                                ...
                                <option value="5">All School</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="date_databank">
                            <label for="select_location">Locations: </label>
                            <select name="select_location" id="select_location" class="form-control">
                                ...
                                <option value="4">Location D</option>
                                <option value="5">All Location</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="btn_area_data_bank">
