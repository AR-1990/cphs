                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Onset2" name="Onset2" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="AssociatedSymptoms2"
                                name="AssociatedSymptoms2" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Onset3" name="Onset3" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Duration3" name="Duration3" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="AssociatedSymptoms3"
                                name="AssociatedSymptoms3" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pattern_fever" name="pattern_fever" required>
                                <option value="">Select</option>
                                <option value="Intermittent"> Intermittent (fever spikes followed by normal temperature)
                                </option>
                                <option value="Remittent">Remittent (fever fluctuates but does not return to normal)
                                </option>
                                <option value="Continuous">Continuous (fever persists without significant fluctuation)
                                </option>
                                <option value="Fever associated with chills or rigors">Fever associated with chills or
                                    rigors</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="recent_exposures" name="recent_exposures" required>
                                <option value="">Select</option>
                                <option value="Exposure to individuals with infectious illnesses">Exposure to individuals
                                    with infectious illnesses</option>
                                <option value="Travel to regions with endemic infectious diseases"> Travel to regions with
                                    endemic infectious diseases</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="ClusterHeadache" name="ClusterHeadache" required>
                                ...
                                <option value="Shorter duration (15 minutes to 3 hours)">Shorter duration (15 minutes to 3
                                    hours)</option>
                                <option value="Associated symptoms: tearing of the eye, nasal congestion, restlessness">
                                    Associated symptoms: tearing of the eye, nasal congestion, restlessness</option>
                                <option
                                    value="Occurs in clusters over weeks to months (episodic) or persistently (chronic)">
                                    Occurs in clusters over weeks to months (episodic) or persistently (chronic)</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="Migraine" name="Migraine" required>
                                ...
                                <option value="Longer duration compared to cluster headaches (4 to 72 hours if untreated)">
                                    Longer duration compared to cluster headaches (4 to 72 hours if untreated)</option>
                                <option value="Associated with nausea, vomiting, photophobia, and phonophobia">Associated
                                    with nausea, vomiting, photophobia, and phonophobia</option>
                                <option
                                    value=" May have prodromal symptoms (aura) such as visual disturbances or sensory changes">
                                    May have prodromal symptoms (aura) such as visual disturbances or sensory changes
                                </option>
                                <option
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="TensionHeadache" name="TensionHeadache" required>
                                ...
                                <option value="Gradual onset of mild to moderate pain">Gradual onset of mild to moderate
                                    pain</option>
                                <option value="Often triggered by stress, poor posture, or muscle tension">Often triggered
                                    by stress, poor posture, or muscle tension</option>
                                <option
                                ...
                                <option value="Can be chronic (frequent episodes) or episodic">Can be chronic (frequent
                                    episodes) or episodic</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="onset_progression" name="onset_progression" required>
                                ...
                                <option value="Rapid progression of symptoms over hours to days">Rapid progression of
                                    symptoms over hours to days</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="Headache" name="Headache" required>
                                ...
                                <option value="Headache may be described as the worst headache of my life">Headache may be
                                    described as "the worst headache of my life"</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="Fever" name="Fever" required>
                                ...
                                <option value="Recent exposure to someone with meningitis or a known outbreak">Recent
                                    exposure to someone with meningitis or a known outbreak</option>
                                <option value="Incomplete or lack of vaccination against bacterial causes of meningitis">
                                    Incomplete or lack of vaccination against bacterial causes of meningitis</option>
                                <option value="none">none</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="relieving_factors" name="relieving_factors" required>
                                ...
                                <option value="Aggravated by movement or certain positions">Aggravated by movement or
                                    certain positions</option>
                                <option value="Relieved by rest or specific positions">Relieved by rest or specific
                                    positions</option>
                                <option value="Aggravated by certain foods or drinks">Aggravated by certain foods or drinks
                                </option>
                                <option value="Associated with bowel movements or urination">Associated with bowel
                                    movements
                                    or urination</option>
                                <option value="none">none</option>
                            </select>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="breathing_difficulties"
                                name="breathing_difficulties" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sleep_related_behaviors"
                                name="sleep_related_behaviors" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="medical_conditions_affecting"
                                name="medical_conditions_affecting" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="medications_impacting_sleep"
                                name="medications_impacting_sleep" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="immunization_history"
                                name="immunization_history" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="episode_per_month"
                                name="episode_per_month" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lower_sputum_color"
                                name="lower_sputum_color" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lower_speutum_quantitiy"
                                name="lower_speutum_quantitiy" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lower_blood_in_sputum"
                                name="lower_blood_in_sputum" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="on_exertion_moderate"
                                name="on_exertion_moderate" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="on_exertion_severe"
                                name="on_exertion_severe" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="infection_episodes_per_month"
                                name="infection_episodes_per_month" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="previous_skin_conditions"
                                name="previous_skin_conditions" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            <label for="skincare_products">Allergies or sensitivities to medications or skincare
                                products</label>
                            <input type="text" class="form-control" id="skincare_products"
                                name="skincare_products" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="family_skin_disease"
                                name="family_skin_disease" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fungal_infections_type"
                                name="fungal_infections_type" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fungal_infections_duration"
                                name="fungal_infections_duration" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fungal_previous_treatments"
                                name="fungal_previous_treatments" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="fungal_infections_recurrence"
                                name="fungal_infections_recurrence" required>
                                <option value="">Select</option>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="dermatitis_triggers"
                                name="dermatitis_triggers" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="dermatitis_symptoms"
                                name="dermatitis_symptoms" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="dermatitis_previous_treatments"
                                name="dermatitis_previous_treatments" required>
                        </div>
                    </div>
                    <h6 class="w-100">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="scabies_previous_treatments"
                                name="scabies_previous_treatments" required>
                        </div>
                    </div>
                    <h6 class="w-100">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="herpes_previous_treatments"
                                name="herpes_previous_treatments" required>
                        </div>
                    </div>
                    <h6 class="w-100">
                        Current Medications
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="herpes_current_medication"
                                name="herpes_current_medication" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="current_additional_notes"
                                name="current_additional_notes" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="regularity_menstrual" name="regularity_menstrual"
                                required>
                                <option value="">Select</option>
                                <option value="Regular (occurring every 21-35 days)">Regular (occurring every 21-35 days)
                                </option>
                                <option value="Irregular (less predictable, varying cycle lengths)">Irregular (less
                                    predictable, varying cycle lengths)</option>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="amount_menstrual_bleeding"
                                name="amount_menstrual_bleeding" required>
                                <option value="">Select</option>
                                <option value="Light (requires only a few pads per day)">Light (requires only a few pads
                                    per day)</option>
                                <option value="Moderate (requires several pads per day)">Moderate (requires several pads
                                    per day)</option>
                                <option value="Heavy (requires frequent pad/tampon changes)">Heavy (requires frequent
                                    pad/tampon changes)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="symptoms_menstruation" name="symptoms_menstruation"
                                required>
                                <option value="">Select</option>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="use_menstrual_products" name="use_menstrual_products"
                                required>
                                <option value="">Select</option>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            <label for="history_menstrual_disorder">Any history of menstrual disorders or
                                complications</label>
                            <select class="form-control" id="history_menstrual_disorder"
                                name="history_menstrual_disorder" required>
                                <option value="">Select</option>
                                ...
                                <option value="Menorrhagia (excessive menstrual bleeding)">Menorrhagia (excessive
                                    menstrual
                                    bleeding)</option>
                                <option value="Oligomenorrhea (infrequent periods)">Oligomenorrhea (infrequent periods)
                                </option>
                                <option value="Other">Other</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group col-md-6" id="dysmenorrhea_div" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="dysmenorrhea_onset"
                                name="dysmenorrhea_onset">
                        </div>
                    </div>
                    <div class="form-group col-md-6" id="amenorrhea_div" style="display:none;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amenorrhea_duration"
                                name="amenorrhea_duration">
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="additional_concerns"
                                name="additional_concerns" required>
                        </div>
                    </div>
                    <h6 class="w-100">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="accident_or_injuries"
                                name="accident_or_injuries" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="any_current_medications"
                                name="any_current_medications" required>
                        </div>
                    </div>
                    <h6 class="w-100">
                        Allergies
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alergies_medications"
                                name="alergies_medications" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            <label for="alergies_chemicals">Chemicals</label>
                            <input type="text" class="form-control" id="alergies_chemicals"
                                name="alergies_chemicals" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="note_to_principal"
                                name="note_to_principal" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
